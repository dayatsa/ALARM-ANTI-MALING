...
_Bool detek, cek_pir, cekdata ;
uint32_t input_key = 0;
uint32_t pass_key[6];
int num_key = 0;
int count_pass = 0;
uint32_t password[6] = {1,4,7,7,4,1};
_Bool cek_pass[6] = {0,0,0,0,0,0};
_Bool boolpir[3] = {0,0,0};
_Bool owner_house = 0;
int count_pir = 0;
char charma[100];
_Bool pir;
...
void cek_PIR(void)
{
	...
	if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((10)<<2)))) == 0 && pir == 0) cek_pir = 1;
		
	if(cek_pir == 1)
	{
		pir = 1;
		if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((10)<<2)))) == 1 && cekdata == 0) 
		{
			count_pir++;
			cekdata = 1;
		}
		else if(cekdata == 1 && (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((10)<<2)))) == 0)
		{
			cek_pir = 0;
		}
...
int main(void)
{
	...
	while(1)
	{
		...
		count_pir = 0;
		if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((10)<<2)))) == 1)
		{
			...
			while(1)
			{
				...
				if( detek == 1 || (detek == 0 && owner_house == 1)) break;
			}
		}
		
		if(detek == 1 && owner_house == 0)
		{
			(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((11)<<2)))) = 0;
			while(1)
			{
